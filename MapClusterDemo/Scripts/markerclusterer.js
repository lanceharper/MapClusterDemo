...
//            if (!markerCounts[marker.state]) {
//                markerCounts[marker.state] = 1;
//            }
//            else {
//                markerCounts[marker.state]++;
//            }
    ...
    //o.displayEventCounts(markerCounts);
};
...
ClusterIcon.prototype.triggerClusterOver = function () {
    ...
    $.each(this.cluster_.markers_, function (i, marker) {
        eventIds.push(marker.eventId);

    });

    $("#cluster-count").html(eventIds.length);
...
ClusterIcon.prototype.onAdd = function () {
    ...
    google.maps.event.addDomListener(this.div_, 'mouseover', function () {
        ...
        if (o.mapping.timer) {
            clearTimeout(o.mapping.timer);
            timer = null;
        }
        o.mapping.timer = setTimeout(function () {
